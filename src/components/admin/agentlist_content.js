...
import "../../css/admin/agentlist.css"
import BaseComponent from "../BaseComponent"

export default class AgentListContent extends BaseComponent{
    render(){
        return (
            <div className="content-right">
                ...
                <div className="am-b-g">
                    ...
                    <div className="cm-table">
                        <table className="am-table am-table-hover ag-table-main">
                            <thead>
                            <tr>
                                <th>代理商名称</th>
                                <th>代理商代理区域</th>
                                ...
                                <th><div className="instruction">
                                    <div className="ins-top">暂停/暂停和其下属商户/删除 <em>说明</em></div>
